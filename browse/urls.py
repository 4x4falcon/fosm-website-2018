...
urlpatterns = [
	...
	url(r'^(?P<type_id>[0-9]+)/history/?$', views.browse_history, {'type': 'node'}, name='browse_history'),

	url(r'^node/(?P<type_id>[0-9]+)$', views.browse_node, name='browse_node'),

#	url(r'^node/(?P<type_id>[0-9]+)/history/$', views.browse_history, {'type': 'node'}, name='browse_node_history'),
