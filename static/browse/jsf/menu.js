...
i18n_strings['javascripts.site.edit_tooltip_josm'] = 'Edit the object in Josm or Merkaartor';
...
//  console.log ('edit_in_josm ' + type + " " + id);
...
//				"onclick" : 'remoteEditHandler(' + type + ', ' + id +' );',
...
// this is for a div
  ...
  $('#linkloader').load("http://127.0.0.1:8111/load_and_zoom?left=" + left + "&top=" + top + "&right=" + right + "&bottom=" + bottom + "&select=" + type + id, isLoaded);
