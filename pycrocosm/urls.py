...
urlpatterns = [
	...
	url(r'^node/', include('browse.urls', namespace='node'), {'type': 'node'}),
	url(r'^way/', include('browse.urls', namespace='way'), {'type': 'way'}),
	url(r'^relation/', include('browse.urls', namespace='relation'), {'type': 'relation'}),
	url(r'^changeset/', include('browse.urls', namespace='changeset'), {'type': 'changeset'}),
	url(r'^contributor/?', include('contributor.urls', namespace='contributor')),
